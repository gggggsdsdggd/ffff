...
local Library = {
	...
	Accent = startupArgs.color or Color3.fromRGB(172, 84, 255),
	Pages = {},
	Sections = {},
	Flags = {},
	UnNamedFlags = 0,
...
if not isfolder(Library.cheatname..'/'..Library.gamename.."/assets") then 
	makefolder(Library.cheatname..'/'..Library.gamename.."/assets")
end
...
if not isfile(Library.cheatname..'/'..Library.gamename.."/assets/main.ttf") then 
	writefile(Library.cheatname..'/'..Library.gamename.."/assets/main.ttf", game:HttpGet("https://raw.githubusercontent.com/Reload-astro/pandora-menu/refs/heads/main/assets/font.ttf"))
end 
	...
	faces = {
		{
			...
			weight = 400,
			style = "normal",
			assetId = getcustomasset(Library.cheatname..'/'..Library.gamename.."/assets/main.ttf")
		}
	}
}
		...
		Button.InputBegan:Connect(function(Input)
			if Input.UserInputType == Enum.UserInputType.MouseButton1 then
				...
				while UserInputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1) do
					...
					TweenService.RenderStepped:Wait()
				end
			end
		end)
	end
...
do
	...
	function Library:Window(Options)
		...
		version.Text = "<font color=\"#4e4e4e\">version: </font> v2"
